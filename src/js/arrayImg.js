...
function Pagina(titulo, descripcion, tecnologias, url,imgGrande, imgPeque) {
  ...
  const paginaCasaItalia = new Pagina("Sistema Comandas Web para CASA ITALIA", "Se trata de una solución especifica para resolver el problema de un negocio local 'Casa Italia' donde ocupaban un sistema de comandas que imprimiera los tickets de venta.", ["html", "css", "sass", "js", "git", "bootstrap"], "https://casaitalia.netlify.app/", "build/img/imgPaginasD/paginaCasaItalia/grande", "build/img/imgPaginasD/paginaCasaItalia/peque");
...
const arregloDePaginas = [paginaCasaItalia,paginaCocina,paginaSolar, paginaPomo, paginaGravity,paginaPortafolio, paginaPaseos];
